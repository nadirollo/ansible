...
short_description: Manage virtual machine customizations specifications
description:
...
options:
    ...
    dns_servers:
      ...
      - This parameter applies to both Linux and Windows customizations.
      required: False
    dns_suffix:
      description:
    ...
    fullname:
      description:
      - Server owner name.
      - This parameter applies to Windows customizations.
      required: False
...
RETURN = r'''
result:
    description: metadata about spec
    returned: always
    type: string
    sample: None
'''
...
class VmwareCustomizationMgr(PyVmomi):
    ...
    def state_create_custom_spec(self):
        ...
        if spec_type == 'Windows':
            ...
            custom_spec.identity.hostName.name = valid_hostname
